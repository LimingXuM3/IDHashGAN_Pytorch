...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 17 22:54:55 2018
...
parser.add_argument('--test_file', default='recon_img.txt', help='cifar10 | nus-wide | mirflickr-25k')
parser.add_argument('--database_label', default='database_label.txt', help='cifar10 | nus-wide | mirflickr-25k')
parser.add_argument('--test_label',  default='recon_label.txt', help='cifar10 | nus-wide | mirflickr-25k')
...
parser.add_argument('--nclass', type=int, default=10, help='number of data loading workers')
...
parser.add_argument('--beta', type=int, default=50, help='hyper parameter')
