...
parser.add_argument('--test_file', default='incomplete_img.txt', help='cifar10 | nus-wide | mirflickr-25k')
parser.add_argument('--database_label', default='database_label.txt', help='cifar10 | nus-wide | mirflickr-25k')
parser.add_argument('--test_label',  default='incomplete_label.txt', help='cifar10 | nus-wide | mirflickr-25k')
...
parser.add_argument('--bits', type=int, default=16, help='number of GPUs to use')
